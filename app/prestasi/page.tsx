                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <div className="mt-1 text-sm text-snow/75">{a.meta}</div>
                      </div>
                      <div className="grid h-10 w-10 place-items-center rounded-xl bg-gold/15 text-gold shadow-[inset_0_0_0_1px_rgba(255,215,0,0.35)]">
              ...
              <div className="rounded-2xl border border-border bg-gradient-to-br from-gold/14 via-surface/60 to-surface-2/60 p-6">
                ...
                <div className="mt-4 grid gap-4">
                  {ATHLETES.map((a) => (
                    <div
                      key={a.name}
                      className="rounded-2xl border border-border bg-ink/35 p-4"
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-snow/70">{a.focus}</div>
                        </div>
                      </div>
                      <div className="mt-3 text-xs text-snow/75">
                        {a.highlight}
                      </div>
                    </div>
                  ))}
              ...
              <div className="rounded-2xl border border-border bg-surface/60 p-6">
                ...
                <div className="mt-4 grid gap-3">
                  {AWARDS.map((a) => (
                    <div
                      key={a.title}
                      className="rounded-xl border border-border bg-ink/30 px-4 py-3"
                    >
                      <div className="text-sm font-semibold text-snow">
                        {a.title}
                      </div>
                      <div className="mt-1 text-xs text-snow/75">{a.desc}</div>
                    </div>
                  ))}
                </div>
              </div>
